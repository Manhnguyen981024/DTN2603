...
public class AccountRepositoryImpl implements IAccountRepository {
    ...
    public boolean save(Account account) {
        try (Connection conn = JdbcUtils.getConnection();
            ...
            setAccountToPreparedStatement(statement, account);
    ...
    private void setAccountToPreparedStatement(PreparedStatement statement, Account account) throws SQLException {
